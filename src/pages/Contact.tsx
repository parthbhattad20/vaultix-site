            ...
            <motion.div variants={itemVariants}>
              <Card className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 border-purple-500/30">
                <CardContent className="p-8">
                  ...
                  <Button variant="outline" size="lg" className="w-full bg-white text-purple-900 hover:bg-slate-100 font-semibold">
                    Schedule Demo
                  </Button>
                </CardContent>
              </Card>
            ...
            <motion.div variants={itemVariants}>
              <Card className="bg-slate-900/50 border-purple-500/20">
                <CardContent className="p-8">
                  ...
                  <Button variant="default" size="lg" className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold">
                    Start Free Trial
                  </Button>
                </CardContent>
              </Card>
